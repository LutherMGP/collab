...
export const FilePaths = {
    ...
    coverImage: (
      ...
      `users/${userId}/projects/${projectId}/data/${category}/${category}CoverImage${resolution}.jpg`,
    ...
    attachmentsFolder: (userId: string, projectId: string, type: "images" | "pdf" | "videos") =>
